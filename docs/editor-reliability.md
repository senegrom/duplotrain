...
Hover and selection highlight the affected piece; frame-coalesced picking repaints
only when the hovered piece changes, not while it stays on one piece or empty
canvas. When several tracks overlap,
