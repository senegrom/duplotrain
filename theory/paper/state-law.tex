...
which its loop is traversed. A single disturbed support coordinate is
encountered once along that switch-simple route. Before contact it is
untouched. At a branch entry the lazy-point rule restores the reference
...
\begin{center}
  \texttt{lake build}
\end{center}
compiles all 53 Lean files and ends by printing the axiom audit of the
single theorem:
\begin{center}
