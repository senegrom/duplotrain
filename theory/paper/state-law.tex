...
development (5,923 lines of Lean~4 in 25 files, using no
...
(\file{SharpCertificateClosure.lean}). Record the initial vector and the
...
\begin{lemma}[Total completion; \file{StateLawNAddFourSharp.lean}]
  \label{lem:cap}
...
\begin{lemma}[Extension preserves live runs;
  ...
  \file{StateLawNAddFourSharp.lean}]\label{lem:extend}
...
argument (\file{TrackTheta.lean}, \file{RunwaySpliceNovelty.lean}).
...
(\file{TrackNoveltyCover.lean}, \file{TripleSelfLinkSimpleCycleClosure.lean}).
...
external library. Run \texttt{lake build} to compile all 25 Lean files;
...
\begin{tabular}{@{}p{0.42\textwidth}p{0.52\textwidth}@{}}
  ...
  \file{StateLawNAddFourSharp.lean} & total completion, the known-edge theorem and the sharp $N+4$ bound\\
