...
development (19,194 lines of Lean~4 in 53 files, using no
...
runway returns, including empty paths. A split at a passage absent from
a prefix must occur in the suffix; this elementary list observation
replaces further orientation-specific splitting arguments.
