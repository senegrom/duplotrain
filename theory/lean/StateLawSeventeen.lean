import KnownEdgeSeventeen

/-! Unconditional entry-free coefficient-17 linear bound. -/

namespace GeneralN

private theorem seventeen_nodup_of_map_nodup
...
private theorem seventeen_nodup_map_filter
...
private theorem seventeen_nodup_filter_nat (p : Nat → Bool) :
...
private theorem seventeen_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `17*N+5` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_seventeen
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 17 * N + 5 := by
  have htimesNodup : times.Nodup :=
    seventeen_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact seventeen_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 17 * N + 4 :=
                known_edge_long_run_distinct_le_seventeen
              ...
              have hzeroBound :
                ...
                seventeen_zero_filter_length_le_one htimesNodup
              have hpartition := seventeen_zero_positive_partition times
