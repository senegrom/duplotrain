...
/-! Unconditional entry-free coefficient-11 linear bound. -/

namespace GeneralN

private theorem eleven_nodup_of_map_nodup
...
private theorem eleven_nodup_map_filter
...
private theorem eleven_nodup_filter_nat (p : Nat → Bool) :
...
private theorem eleven_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `11*N+9` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_eleven
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 11 * N + 9 := by
  have htimesNodup : times.Nodup :=
    eleven_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact eleven_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 11 * N + 8 :=
                known_edge_long_run_distinct_le_eleven
              ...
              have hzeroBound :
                ...
                eleven_zero_filter_length_le_one htimesNodup
              have hpartition := eleven_zero_positive_partition times
