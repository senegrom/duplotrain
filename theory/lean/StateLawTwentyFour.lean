import KnownEdgeTwentyFour

/-! Unconditional entry-free linear bound. -/

namespace GeneralN

private theorem improved_nodup_of_map_nodup
...
private theorem improved_nodup_map_filter
...
private theorem improved_nodup_filter_nat (p : Nat → Bool) :
...
private theorem improved_zero_positive_partition :
    ∀ xs : List Nat,
...
/-- **Improved unconditional linear state bound.** -/
theorem state_law_linear_twenty_four
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 24 * N + 5 := by
  have htimesNodup : times.Nodup :=
    improved_nodup_of_map_nodup (restrictedTonguesAt w N start) hnd
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact improved_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 24 * N + 4 :=
                known_edge_long_run_distinct_le_twenty_four
              ...
              have hzeroBound :
                ...
                improved_zero_filter_length_le_one htimesNodup
              have hpartition := improved_zero_positive_partition times
