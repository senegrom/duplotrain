...
/-! Known-edge overlap-aware linear bound. -/

namespace GeneralN

/-- Known-edge long-run form of the overlap-aware `24*N+2` bound. -/
theorem known_edge_long_run_distinct_le_twenty_four_overlap
    {w : Wiring} {N e : Nat}
  ...
  · obtain ⟨A, B, stateA, stateB,
    ...
    exact two_manufacturing_journeys_then_repair_distinct_le_overlap
