import KnownEdgeTwentyFourOverlap

/-! Unconditional entry-free overlap-aware linear bound. -/

namespace GeneralN

private theorem overlap_nodup_of_map_nodup
...
private theorem overlap_nodup_map_filter
...
private theorem overlap_nodup_filter_nat (p : Nat → Bool) :
...
private theorem overlap_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `24*N+3` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_twenty_four_overlap
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 24 * N + 3 := by
  have htimesNodup : times.Nodup :=
    overlap_nodup_of_map_nodup (restrictedTonguesAt w N start) hnd
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact overlap_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 24 * N + 2 :=
                known_edge_long_run_distinct_le_twenty_four_overlap
              ...
              have hzeroBound :
                ...
                overlap_zero_filter_length_le_one htimesNodup
              have hpartition := overlap_zero_positive_partition times
