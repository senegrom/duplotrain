import KnownEdgeTwenty

/-! Unconditional entry-free coefficient-20 linear bound. -/

namespace GeneralN

private theorem twenty_nodup_of_map_nodup
...
private theorem twenty_nodup_map_filter
...
private theorem twenty_nodup_filter_nat (p : Nat → Bool) :
...
private theorem twenty_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `20*N+3` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_twenty
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 20 * N + 3 := by
  have htimesNodup : times.Nodup :=
    twenty_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact twenty_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 20 * N + 2 :=
                known_edge_long_run_distinct_le_twenty
              ...
              have hzeroBound :
                ...
                twenty_zero_filter_length_le_one htimesNodup
              have hpartition := twenty_zero_positive_partition times
