import KnownEdgeNineteen

/-! Unconditional entry-free coefficient-19 linear bound. -/

namespace GeneralN

private theorem nineteen_nodup_of_map_nodup
...
private theorem nineteen_nodup_map_filter
...
private theorem nineteen_nodup_filter_nat (p : Nat → Bool) :
...
private theorem nineteen_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `19*N+3` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_nineteen
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 19 * N + 3 := by
  have htimesNodup : times.Nodup :=
    nineteen_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact nineteen_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 19 * N + 2 :=
                known_edge_long_run_distinct_le_nineteen
              ...
              have hzeroBound :
                ...
                nineteen_zero_filter_length_le_one htimesNodup
              have hpartition := nineteen_zero_positive_partition times
