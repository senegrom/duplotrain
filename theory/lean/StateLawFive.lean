...
/-! Unconditional entry-free coefficient-5 linear bound. -/

namespace GeneralN

private theorem five_nodup_of_map_nodup
...
private theorem five_nodup_map_filter
...
private theorem five_nodup_filter_nat (p : Nat → Bool) :
...
private theorem five_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `5*N+9` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_five
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 5 * N + 9 := by
  have htimesNodup : times.Nodup :=
    five_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact five_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 5 * N + 8 :=
                known_edge_long_run_distinct_le_five
              ...
              have hzeroBound :
                ...
                five_zero_filter_length_le_one htimesNodup
              have hpartition := five_zero_positive_partition times
