import KnownEdgeFour

/-! Unconditional entry-free coefficient-4 linear bound. -/

namespace GeneralN

private theorem four_nodup_of_map_nodup
...
private theorem four_nodup_map_filter
...
private theorem four_nodup_filter_nat (p : Nat → Bool) :
...
private theorem four_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `4*N+9` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_four
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 4 * N + 9 := by
  have htimesNodup : times.Nodup :=
    four_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact four_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 4 * N + 8 :=
                known_edge_long_run_distinct_le_four
              ...
              have hzeroBound :
                ...
                four_zero_filter_length_le_one htimesNodup
              have hpartition := four_zero_positive_partition times
