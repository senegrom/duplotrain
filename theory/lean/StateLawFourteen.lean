...
/-! Unconditional entry-free coefficient-14 linear bound. -/

namespace GeneralN

private theorem fourteen_nodup_of_map_nodup
...
private theorem fourteen_nodup_map_filter
...
private theorem fourteen_nodup_filter_nat (p : Nat → Bool) :
...
private theorem fourteen_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `14*N+9` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_fourteen
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 14 * N + 9 := by
  have htimesNodup : times.Nodup :=
    fourteen_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact fourteen_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 14 * N + 8 :=
                known_edge_long_run_distinct_le_fourteen
              ...
              have hzeroBound :
                ...
                fourteen_zero_filter_length_le_one htimesNodup
              have hpartition := fourteen_zero_positive_partition times
