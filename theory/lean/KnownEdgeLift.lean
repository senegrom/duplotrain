...
private theorem kel_nodup_of_map_nodup
...
private theorem kel_nodup_map_filter
...
private theorem kel_nodup_filter_nat (p : Nat → Bool) :
...
private theorem kel_zero_positive_partition :
    ∀ xs : List Nat,
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact kel_nodup_map_filter _ hnd
              have hshiftedNodup :
