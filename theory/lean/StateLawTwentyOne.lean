import KnownEdgeTwentyOne

/-! Unconditional entry-free coefficient-21 linear bound. -/

namespace GeneralN

private theorem twenty_one_nodup_of_map_nodup
...
private theorem twenty_one_nodup_map_filter
...
private theorem twenty_one_nodup_filter_nat (p : Nat → Bool) :
...
private theorem twenty_one_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `21*N+3` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_twenty_one
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 21 * N + 3 := by
  have htimesNodup : times.Nodup :=
    twenty_one_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact twenty_one_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 21 * N + 2 :=
                known_edge_long_run_distinct_le_twenty_one
              ...
              have hzeroBound :
                ...
                twenty_one_zero_filter_length_le_one htimesNodup
              have hpartition :=
                twenty_one_zero_positive_partition times
