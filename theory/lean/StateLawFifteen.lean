import KnownEdgeFifteen

/-! Unconditional entry-free coefficient-15 linear bound. -/

namespace GeneralN

private theorem fifteen_nodup_of_map_nodup
...
private theorem fifteen_nodup_map_filter
...
private theorem fifteen_nodup_filter_nat (p : Nat → Bool) :
...
private theorem fifteen_zero_positive_partition :
    ∀ xs : List Nat,
...
has at most `15*N+7` pairwise-distinct restricted tongue vectors. -/
theorem state_law_linear_fifteen
    (w : Wiring) (N : Nat)
    ...
    times.length ≤ 15 * N + 7 := by
  have htimesNodup : times.Nodup :=
    fifteen_nodup_of_map_nodup
      ...
      | some middle =>
          ...
          | some entry =>
              ...
              have hpositiveNodup :
                ...
                dsimp [positive]
                exact fifteen_nodup_map_filter _ hnd
              have hshiftedNodup :
              ...
              have hshiftedLive : ∀ d ∈ shifted,
                ...
                exact hkLive
              have hshiftedBound : shifted.length ≤ 15 * N + 6 :=
                known_edge_long_run_distinct_le_fifteen
              ...
              have hzeroBound :
                ...
                fifteen_zero_filter_length_le_one htimesNodup
              have hpartition := fifteen_zero_positive_partition times
