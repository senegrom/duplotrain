...
import NoveltyAwareLassoNineteen

/-! Known-edge coefficient-19 linear bound. -/

namespace GeneralN

/-- Known-edge long-run form of the `19*N+2` bound. -/
theorem known_edge_long_run_distinct_le_nineteen
    {w : Wiring} {N e : Nat}
  ...
  · obtain ⟨A, B, stateA, stateB,
    ...
    have hlocal := manufactured_pair_protected_repair_within_seventeen
      hN A B hAatBase hBatActivated
    rw [← hactivatedB] at hlocal
    exact two_manufacturing_journeys_then_repair_distinct_le_nineteen
