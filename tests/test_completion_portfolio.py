...
def test_wrong_end_is_not_allowed_to_spend_the_whole_budget(monkeypatch):
    ...
    assert calls == [((5, 1), (0, 0), 24), ((0, 0), (5, 1), 49)]
...
@pytest.mark.parametrize("budget", [32, 33, 100, 25_000, 250_000])
def test_exhausted_probes_share_one_hard_node_allowance(monkeypatch, budget):
    catalog, base, stock = small_case()
    calls = []
